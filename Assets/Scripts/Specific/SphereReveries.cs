...
public class SphereReveries : MonoBehaviour
{
    ...
    public IEnumerator Ignition(Dir dir)
    {
        ...
        GameController.Instance.Sphere.RollArround(LeanDir, percent: 8f, animT: _leanAnimationTime);
    ...
    public void AtRest()
    {
        ...
        GameController.Instance.Sphere.RollArround(LeanDir, percent: 8f, animT: _leanAnimationTime, reverse: true);
