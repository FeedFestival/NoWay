...
public class SoundManager : MonoBehaviour
{
    ...
    {
        var audioClip = Resources.Load("sound/" + resource, typeof(AudioClip)) as AudioClip;

        CrossFade(audioClip, 0.25f, 0.01f, 0f);
    }
    ...
    public void PlayLetterSound()
    {
        ...
        {
            _audioClipLetter = Resources.Load("sound/keyboard", typeof(AudioClip)) as AudioClip;
        }
        
        CrossFade(_audioClipLetter, 0.25f, 0.01f, 0f);
    }
